...
typedef std::pair<G4String, G4String> G4Strings;
typedef std::pair<G4ThreeVector, G4ThreeVector> G4ThreeVectors;
...
static const G4ThreeVectors gScintillatorsPosition(G4ThreeVector(0.0, 0.0, gUpperScintillatorzPosition), G4ThreeVector(0.0, 0.0, -gUpperScintillatorzPosition));

static const G4String gScintillatorGeneralName("scintillator");
static const G4Strings gScintillatorsName("upper_scintillator", "lower_scintillator");
...
static const G4Strings gAlFoilsName("upper_al_foil", "lower_al_foil");
...
static const G4ThreeVectors gSiPMsPosition(G4ThreeVector(0.0, 0.0, gUpperSiPMzPosition), G4ThreeVector(0.0, 0.0, -gUpperSiPMzPosition));

static const G4String gSiPMGeneralName("SiPM");
static const G4Strings gSiPMsName("upper_SiPM", "lower_SiPM");
...
static const G4ThreeVectors gLightGuidesPosition(G4ThreeVector(0.0, 0.0, gUpperLightGuidezPosition), G4ThreeVector(0.0, 0.0, -gUpperLightGuidezPosition));

static const G4String gLightGuideGeneralName("light_guide");
static const G4Strings gLightGuidesName("upper_light_guide", "lower_light_guide");
...
static const G4ThreeVectors gPCBsPosition(G4ThreeVector(0.0, 0.0, gUpperPCBzPosition), G4ThreeVector(0.0, 0.0, -gUpperPCBzPosition));

static const G4String gPCBGeneralName("PCB");
static const G4Strings gPCBsName("upper_PCB", "lower_PCB");
